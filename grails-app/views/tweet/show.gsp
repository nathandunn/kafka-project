	...
	<body>
		...
		<div id="show-tweet" class="content scaffold-show" role="main">
			...
			<ol class="property-list tweet">
				...
				<g:if test="${tweetInstance?.postDate}">
				<li class="fieldcontain">
					<span id="postDate-label" class="property-label"><g:message code="tweet.postDate.label" default="Post Date" /></span>
					
						<span class="property-value" aria-labelledby="postDate-label"><g:formatDate date="${tweetInstance?.postDate}" /></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="tweet.user.label" default="User" /></span>
						...
						<span class="property-value" aria-labelledby="user-label"><g:fieldValue bean="${tweetInstance}" field="user"/></span>
